...
function getRotationDirection({ left, right, isMouseLooking }: any) {
  let direction = 0;
  if (!isMouseLooking) {
    if (left) {
      direction = -1;
...
function getMovementDirection({ up, down, right, left, isMouseLooking }: any) {
...
function getModelRotation(inputs: any) {
...
export default function useInputMovementRotation(inputs: any) {
